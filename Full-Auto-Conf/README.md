...
## Before starting
This part is based on the executbale from [this C++ code]() which call some specials commands contained in hidens folder. You can analyse the code and adapt it if you want or you can follow the steps below to get a full auto configuration. 
